...
sys.path.append('./Seq2Seq-Chatbot-master')
...
save_path = "/Users/nguyenquan/Desktop/Project/Project_ML/seq2seq_chatbot/Seq2Seq-Chatbot-master/" + model_dir + '/' + save_path
print(save_path)
