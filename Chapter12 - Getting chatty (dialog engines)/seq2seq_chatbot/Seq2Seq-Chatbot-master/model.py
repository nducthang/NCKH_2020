...
def decoder_layer(rnn_size, encoder_outputs, target_data_len,
    ...
    outputs_train = decoder_train_layer(rnn_size, decoder_input_tensor, dec_cell_inputs, target_vocab_size,
                                        target_data_len, encoder_outputs, encoder_states, batch_size, attention_cell,
                                        state, dense_layer)
    outputs_infer = decoder_infer_layer(decoder_embeddings, batch_size, vocabs_to_index, attention_cell, state,
                                        dense_layer, target_data_len)
...
def seq2seq_model(source_vocab_size, embed_size, rnn_size, keep_prob,
    ...
    outputs_train, outputs_infer = decoder_layer(rnn_size, encoder_outputs, target_data_len,
                                                 dec_cell, encoder_states, target_data, vocabs_to_index,
                                                 target_vocab_size,
                                                 embed_size, dense_layer, attention_cell, state, batch_size)
